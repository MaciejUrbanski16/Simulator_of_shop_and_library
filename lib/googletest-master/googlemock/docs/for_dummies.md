...
*   Now comes the fun part: you take the function signature, cut-and-paste it
    ...
    titleOfBooksInShop, another between the titleOfBooksInShop and the argument list.
...
[cook books](http://<!-- GOOGLETEST_CM0012 DO NOT DELETE -->).
...
its titleOfBooksInShop is really irrelevant.
